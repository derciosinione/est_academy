...
INSERT INTO Users (Name, Email, PasswordHash, IsApproved, IsActive, IsDeleted, ProfileId, CreatedAt, UpdatedAt)
VALUES ('João Aluno', 'joao.aluno@email.com', 'senha_aluno', TRUE, TRUE, FALSE, 1, NOW(), NOW());

INSERT INTO Users (Name, Email, PasswordHash, IsApproved, IsActive, IsDeleted, ProfileId, CreatedAt, UpdatedAt)
VALUES ('Maria Docente', 'maria.docente@email.com', 'senha_docente', TRUE, TRUE, FALSE, 2, NOW(), NOW());


INSERT INTO Users (Name, Email, PasswordHash, IsApproved, IsActive, IsDeleted, ProfileId, CreatedAt, UpdatedAt)
VALUES ('Dercio Sinione', 'dercio.sinione@email.com', 'senha_admin', TRUE, TRUE, FALSE, 3, NOW(), NOW());

INSERT INTO Users (Name, Email, PasswordHash, IsApproved, IsActive, IsDeleted, ProfileId, CreatedAt, UpdatedAt)
VALUES ('Carlos Administrador', 'carlos.admin@email.com', 'senha_admin', TRUE, TRUE, FALSE, 3, NOW(), NOW());
...
VALUES (4, 'admin', 'admin', 'admin@gmail.com', '+55123123123', NULL, '1992-05-01', 'admin', TRUE, TRUE, FALSE, 3,
        NOW(), NOW()),
       ...
       (2, 'docente', 'docente', 'docente@gmail.com', '+55123123312', NULL, '1992-05-01', 'docente', TRUE, TRUE, FALSE,
        2, NOW(), NOW()),
       (1, 'aluno', 'aluno', 'aluno@gmail.com', '+551231232', NULL, '1992-05-01', 'aluno', TRUE, TRUE, FALSE, 1, NOW(),
        NOW());
...
VALUES ('Maria Silva', 'maria.silva@example.com', '+55123456789', NULL, '1995-07-15', 'senha123', TRUE, TRUE, FALSE, 1,
       ...
       ('Pedro Lima', 'pedro.lima@example.com', '+55456789012', NULL, '1997-05-25', 'senhaabc', TRUE, TRUE, FALSE, 1,
        NOW(), NOW()),
       ('Ana Rodrigues', 'ana.rodrigues@example.com', '+55567890123', NULL, '1996-11-30', 'senhadef', TRUE, TRUE, FALSE,
        1, NOW(), NOW()),
       ('Rafaela Oliveira', 'rafaela.oliveira@example.com', '+55678901234', NULL, '1993-04-05', 'senha123', TRUE, TRUE,
        FALSE, 1, NOW(), NOW()),
       ('Fernando Costa', 'fernando.costa@example.com', '+55789012345', NULL, '1992-08-12', 'senha456', TRUE, TRUE,
        FALSE, 1, NOW(), NOW()),
       ('Gustavo Pereira', 'gustavo.pereira@example.com', '+55890123456', NULL, '1999-01-18', 'senha789', TRUE, TRUE,
        FALSE, 1, NOW(), NOW()),
       ('Patrícia Silva', 'patricia.silva@example.com', '+55901234567', NULL, '1991-03-22', 'senhaabc', TRUE, TRUE,
        FALSE, 1, NOW(), NOW()),
       ('Mariana Santos', 'mariana.santos@example.com', '+55123123456', NULL, '1990-06-14', 'senhadef', TRUE, TRUE,
        FALSE, 1, NOW(), NOW()),
